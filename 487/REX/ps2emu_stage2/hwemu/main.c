...
#elif defined(FIRMWARE_4_76) || defined(FIRMWARE_4_84) || defined(FIRMWARE_4_85) || defined(FIRMWARE_4_86) || defined(FIRMWARE_4_87) // the same as 4.65

#define AUTH_OFFSET		0x20700 //0x20680 4.46
#define DISC_SIZE_OFFSET	0x25714 //0x25694 4.46
#define DISC_TYPE_OFFSET	0x25404 //0x25384 4.46

#endif

#if defined(FIRMWARE_3_41) || defined(FIRMWARE_3_55) || defined(FIRMWARE_4_30) || defined(FIRMWARE_4_76) || defined(FIRMWARE_4_84) || defined(FIRMWARE_4_85) || defined(FIRMWARE_4_86) || defined(FIRMWARE_4_87)
