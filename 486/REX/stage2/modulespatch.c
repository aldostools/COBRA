...
#if defined(patch1_nas) && defined(patch2_nas) && defined(patch3_nas)
...
#endif
#if defined(bdp_cinavia_patch) && defined(bdp_cinavia1_patch)
...
#endif
#if defined(elf_patch1_autodownload) && defined(elf_patch2_autodownload)
...
#endif
#if defined(premo_plugin_patches)
...
#endif
#if defined(pcremote_play_offset2)
